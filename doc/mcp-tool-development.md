...
`org.wildfly.mcp.api.McpParamHeader` is a parameter annotation that injects a value from
...
- **`@McpParamHeader` values are client-supplied**: Treat them as untrusted input. Do not use
