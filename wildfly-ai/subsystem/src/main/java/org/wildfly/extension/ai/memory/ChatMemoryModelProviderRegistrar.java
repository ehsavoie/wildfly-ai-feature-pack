...
public class ChatMemoryModelProviderRegistrar implements ChildResourceDefinitionRegistrar {
    ...
    public ChatMemoryModelProviderRegistrar(ParentResourceDescriptionResolver parentResolver) {
