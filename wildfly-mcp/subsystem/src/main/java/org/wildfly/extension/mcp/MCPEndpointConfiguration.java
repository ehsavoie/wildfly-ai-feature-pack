 ...
 */
public record MCPEndpointConfiguration(String ssePath, String messagesPath, String streamablePath, int pageSize, long timeout, long requestTimeoutSeconds, String requestStateSecret, Set<String> allowedOrigins, long cacheTtlMs, String cacheScope) {

    public MCPEndpointConfiguration(String ssePath, String messagesPath, String streamablePath, int pageSize, long timeout) {
        this(ssePath, messagesPath, streamablePath, pageSize, timeout, 300L, null, Set.of(), 3_600_000L, "public");
    }
}