...
public class MCPSseHandlerServiceInstaller implements DeploymentServiceInstaller {
    ...
    public void install(DeploymentPhaseContext context) {
        ...
        final StreamableHttpHandler streamableHttpHandler = new StreamableHttpHandler(connectionManager, mcpMessageHandler, Handlers.serverSentEvents(mcpStreamableConnectionCallBack), configuration.allowedOrigins(), configuration.requestTimeoutSeconds());
